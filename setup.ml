...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2815302417b19bd14a182ec43cead62c) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ZMQ"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "hwserver.ml"});
               Executable
                 ({
                     cs_name = "hwclient";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "hwclient.ml"});
               Executable
                 ({
                     cs_name = "wuserver";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "wuserver.ml"});
               Executable
                 ({
                     cs_name = "wuclient";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "ZMQ"; FindlibPackage ("str", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "wuclient.ml"});
               Executable
                 ({
                     cs_name = "wuproxy";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "wuproxy.ml"});
               Executable
                 ({
                     cs_name = "taskvent";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "taskvent.ml"});
               Executable
                 ({
                     cs_name = "taskwork";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "taskwork.ml"});
               Executable
                 ({
                     cs_name = "tasksink";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "tasksink.ml"});
               Executable
                 ({
                     cs_name = "threadedloopback";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "threaded_loopback.ml"
                   });
               Executable
                 ({
                     cs_name = "echoserver";
                   ...
                   {exec_custom = false; exec_main_is = "echoserver.ml"});
               Executable
                 ({
                     cs_name = "echoclient";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "echoclient.ml"});
               Test
                 ({
                     cs_name = "main";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "s\168\020\206\r\234\2135\176\200\145A\185e\224\161";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
